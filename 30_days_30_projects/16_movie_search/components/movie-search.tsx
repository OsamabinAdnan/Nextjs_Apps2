...
export default function MovieSearch() {
    ...
    const handleSearch = async (): Promise<void> => {
        ...
        try {
            // get the free api key from https://www.omdbapi.com/apikey.aspx
    ...
    const handleChange = (e : ChangeEvent<HTMLInputElement>) : void => {
        setSearchTerm(e.target.value); // Update search term state with the input value
    }
    ...
    <>
        <div className='flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4'>
            <div className='w-full max-w-lg p-6 bg-white rounded-lg shadow-md'>
                ...
                <div className="flex md:flex-row flex-col items-center mb-6 gap-2">
                    {/* Search input field */}
                    <Input
                        type='text'
                ...
                {movieDetails && (
                    <div className='flex flex-col items-center'>
                        ...
                        <div className='w-full text-center'>
                            ...
                            <div className='flex justify-center items-center text-gray-500 mb-2 gap-2'>
